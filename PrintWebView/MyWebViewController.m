...
- (void)viewDidLoad
{
    ...
    urlField.placeholder = @"<请输入一个完整的地址>";
    urlField.text = @"http://stevehelloworld.com";
    ...
    [self.myWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://stevehelloworld.com/"]]];
}
